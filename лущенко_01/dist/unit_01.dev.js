...
document.getElementById("seven").innerHTML = 12 * 12; // Task 8.
// На странице создан div.out-8. С помощью document.querySelector запишите в данный элемент текст 'task-8'.

document.querySelector(".out-8").innerHTML = "task-8"; // Task 9.
...
document.querySelector("span.out-8").innerHTML = "world"; // Task 10.
//На странице создан div.out-10. С помощью innerHTML запишите внутрь него следующую строку '<h2>Hi</h2>'.

document.querySelector(".out-10").innerHTML = "<h2>Hi</h2>"; // Task 11.
...
document.querySelector(".out-11").innerHTML += "456"; // Task 12.
...
var a = document.querySelector(".out-12"); // document.querySelector(".out-12").innerHTML = 3.1415;

a.innerHTML = 3.1415; // Task 13.
...
out13.innerHTML = '<img src="https://itgid.info/img/js20/js20_unit_01.png" alt="js">'; // Task 14.
//Создайте две переменных z1 = 6, z2 = 3. В div.out-14  выведите результат умножение z1 на z2.

var z1 = 6;
var z2 = 3;
document.querySelector(".out-14").innerHTML = z1 * z2; // Task 15.

var y1 = 6;
var y2 = 3;
document.querySelector(".out-15").innerHTML = y1 / y2; // Создайте две переменных y1 = 6, y2 = 3. В div.out-15 выведите результат него деления y1 на y2.
// Task 16.
// Создайте две переменные x1='Hello', x2 = 5.  В div.out-16 выведите сумму x1 + x2. Изучите результат операции.

var x1 = "Hello";
var x2 = 5;
document.querySelector(".out-16").innerHTML = x1 + x2; // Task 17.
...
console.log("out17"); // console.dir(out - 17);
...
var out19 = document.querySelector(".out-19");
console.log(out19);
out19 = document.querySelector(".out-19-test");
console.log(out19); // Task 20
