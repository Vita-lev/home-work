...
var c = 7;
var d = 9;
document.querySelector(".out-2").textContent = c / d; // Task 3.
// Создайте две переменные e = 3 и f = 5. Выведите на страницу  в .out-3 результат сложения e + f.

var e = 3;
var f = 5;
document.querySelector(".out-3").textContent = e + f; // Task 4.
// Создайте две переменные e1 = '3' и f1 = 5. Выведите на страницу  в .out-4 результат сложения e1 + f1. Объясните разницу.

var e1 = "3";
var f1 = 5;
document.querySelector(".out-4").textContent = e1 + f1; // Task 5.
// Создайте две переменные e2 = 3 и f2 = 0. Выведите на страницу  в .out-5 результат деления e2 на f2.

var e2 = 3;
var f2 = 0;
document.querySelector(".out-5").textContent = e2 / f2; // Task 6.
// Создайте две переменные e3 = 3 и f3 = 'Hello'. Выведите на страницу  в .out-6 результат сложения двух переменных.

var e3 = 3;
var f3 = "Hello";
document.querySelector(".out-6").textContent = e3 + f3; // Task 7.
...
function t9() {
  var data = document.querySelector(".i-9");
...
document.querySelector(".b-11").onclick = t11; // Task 12.
...
document.querySelector(".b-12").onclick = t12; // Task 13.
...
document.querySelector(".b-16").onclick = t16; // Task 17.
...
function t17() {
  var a = document.querySelector(".i-17").value;
...
document.querySelector(".b-17").onclick = t17; // Task 18.
